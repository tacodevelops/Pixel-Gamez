...
export const games: Game[] = [
  { id: 'polytrack', title: 'Polytrack', description: 'Create tracks, race against time, and share your creations in this low-poly track builder!', category: 'driving', tags: ['popular', 'new'], thumbnail: '/images/games/driving/polytrack.png', embedUrl: 'https://games.crazygames.com/en_US/polytrack/index.html', rating: 0, plays: 0 },
  { id: 'openfront-gsw', title: 'Openfront GSW', description: 'Intense tactical shooter action. Secure the area and eliminate threats.', category: 'shooting', tags: ['action'], thumbnail: '/images/games/shooting/openfront-gsw.png', embedUrl: 'https://games.crazygames.com/en_US/openfront-gsw/index.html', rating: 0, plays: 0 },
  { id: 'leek-factory-tycoon', title: 'Leek Factory Tycoon', description: 'Build and manage your own leek factory empire. Automate production and become rich!', category: 'simulation', tags: ['new', 'popular'], thumbnail: '/images/games/simulation/leek-factory-tycoon.png', embedUrl: 'https://games.crazygames.com/en_US/leek-factory-tycoon/index.html', rating: 0, plays: 0 },
  { id: 'frontwars-io', title: 'Frontwars.io', description: 'Jump into intense multiplayer battles on the frontline. Dominate the arena!', category: 'shooting', tags: ['action', 'new'], thumbnail: '/images/games/shooting/frontwars-io.png', embedUrl: 'https://games.crazygames.com/en_US/frontwars-io/index.html', rating: 0, plays: 0 },
  { id: 'artillery-vs-tanks', title: 'Artillery vs Tanks', description: 'Command heavy artillery to defend against waves of enemy tanks.', category: 'action', tags: ['shooting', 'popular'], thumbnail: '/images/games/action/artillery-vs-tanks.png', embedUrl: 'https://games.crazygames.com/en_US/artillery-vs-tanks/index.html', rating: 0, plays: 0 },
  { id: 'space-waves', title: 'Space Waves', description: 'Navigate your ship through challenging cosmic waves and obstacles.', category: 'arcade', tags: ['action'], thumbnail: '/images/games/arcade/space-waves.png', embedUrl: 'https://games.crazygames.com/en_US/space-waves/index.html', rating: 0, plays: 0 },
  { id: 'lumber-harvest-tree-cutting-game', title: 'Lumber Harvest', description: 'Grab your axe and start harvesting trees to build your lumber empire.', category: 'simulation', tags: ['new'], thumbnail: '/images/games/simulation/lumber-harvest-tree-cutting-game.png', embedUrl: 'https://games.crazygames.com/en_US/lumber-harvest-tree-cutting-game/index.html', rating: 0, plays: 0 },
  { id: 'stone-grass-mowing-simulator', title: 'Stone Grass Mowing', description: 'Experience the satisfying job of mowing grass in this relaxing simulator.', category: 'simulation', tags: ['popular'], thumbnail: '/images/games/simulation/stone-grass-mowing-simulator.png', embedUrl: 'https://games.crazygames.com/en_US/stone-grass-mowing-simulator/index.html', rating: 0, plays: 0 },
  { id: 'drift-boss', title: 'Drift Boss', description: 'Master the art of drifting on tricky zigzag tracks.', category: 'driving', tags: ['action', 'popular'], thumbnail: '/images/games/driving/drift-boss.png', embedUrl: 'https://games.crazygames.com/en_US/drift-boss/index.html', rating: 0, plays: 0 },
  { id: 'escape-road-asm', title: 'Escape Road', description: 'Outrun the cops in this thrilling endless driving game.', category: 'driving', tags: ['action'], thumbnail: '/images/games/driving/escape-road-asm.png', embedUrl: 'https://games.crazygames.com/en_US/escape-road-asm/index.html', rating: 0, plays: 0 },
  { id: 'snow-rider-3d', title: 'Snow Rider 3D', description: 'Hit the slopes and perform amazing tricks in this 3D snowboarding adventure.', category: 'sports', tags: ['popular', 'action'], thumbnail: '/images/games/sports/snow-rider-3d.png', embedUrl: 'https://games.crazygames.com/en_US/snow-rider-3d/index.html', rating: 0, plays: 0 },
  { id: 'golf-orbit', title: 'Golf Orbit', description: 'Hit the golf ball as far as possible into orbit!', category: 'sports', tags: ['arcade'], thumbnail: '/images/games/sports/golf-orbit.png', embedUrl: 'https://games.crazygames.com/en_US/golf-orbit/index.html', rating: 0, plays: 0 },
  { id: 'mini-golf-club', title: 'Mini Golf Club', description: 'Multiplayer mini golf with crazy courses and fun physics.', category: 'sports', tags: ['popular'], thumbnail: '/images/games/sports/mini-golf-club.png', embedUrl: 'https://games.crazygames.com/en_US/mini-golf-club/index.html', rating: 0, plays: 0 },
  ...
  { id: 'cozy-golf', title: 'Cozy Golf', description: 'A relaxing and aesthetic golfing experience.', category: 'sports', tags: ['new'], thumbnail: '/images/games/sports/cozy-golf.png', embedUrl: 'https://games.crazygames.com/en_US/cozy-golf/index.html', rating: 0, plays: 0 },
  { id: 'basketball-orbit', title: 'Basketball Orbit', description: 'Shoot hoops into space in this over-the-top basketball game.', category: 'sports', tags: ['arcade'], thumbnail: '/images/games/sports/basketball-orbit.png', embedUrl: 'https://games.crazygames.com/en_US/basketball-orbit/index.html', rating: 0, plays: 0 },
  { id: 'capybara-clicker', title: 'Capybara Clicker', description: 'Click the capybara, buy upgrades, and rule the capybara world!', category: 'clicker', tags: ['popular', 'funny'], thumbnail: '/images/games/clicker/capybara-clicker.png', embedUrl: 'https://games.crazygames.com/en_US/capybara-clicker/index.html', rating: 0, plays: 0 },
  { id: 'count-masters-stickman-games', title: 'Count Masters', description: 'Gather a huge crowd of stickmen and clash against rival groups.', category: 'action', tags: ['arcade', 'popular'], thumbnail: '/images/games/action/count-masters-stickman-games.png', embedUrl: 'https://games.crazygames.com/en_US/count-masters-stickman-games/index.html', rating: 0, plays: 0 },
  { id: 'rocketgoal-io', title: 'Rocketgoal.io', description: 'Car soccer chaos! Boost and score in this rocket-powered sports game.', category: 'sports', tags: ['action', 'new'], thumbnail: '/images/games/sports/rocketgoal-io.png', embedUrl: 'https://games.crazygames.com/en_US/rocketgoal-io/index.html', rating: 0, plays: 0 },
  { id: 'redcoats-io-rcr', title: 'Redcoats.io', description: 'Historical multiplayer battles. Choose your side and fight!', category: 'shooting', tags: ['action'], thumbnail: '/images/games/shooting/redcoats-io-rcr.png', embedUrl: 'https://games.crazygames.com/en_US/redcoats-io-rcr/index.html', rating: 0, plays: 0 },
  { id: 'elevator-room-escape', title: 'Elevator Room Escape', description: 'Solve puzzles to escape the mysterious elevator.', category: 'puzzle', tags: ['new'], thumbnail: '/images/games/puzzle/elevator-room-escape.png', embedUrl: 'https://games.crazygames.com/en_US/elevator-room-escape/index.html', rating: 0, plays: 0 },
  { id: 'paint-room-escape', title: 'Paint Room Escape', description: 'Use your wits to find the hidden clues and escape the paint room.', category: 'puzzle', tags: [], thumbnail: '/images/games/puzzle/paint-room-escape.png', embedUrl: 'https://games.crazygames.com/en_US/paint-room-escape/index.html', rating: 0, plays: 0 },
  { id: 'idle-billionaire-tycoon', title: 'Idle Billionaire Tycoon', description: 'Start from nothing and build a massive financial empire.', category: 'simulation', tags: ['popular'], thumbnail: '/images/games/simulation/idle-billionaire-tycoon.png', embedUrl: 'https://games.crazygames.com/en_US/idle-billionaire-tycoon/index.html', rating: 0, plays: 0 },
  { id: 'drift-tycoon', title: 'Drift Tycoon', description: 'Manage your drift circuit, upgrade cars, and become a drift tycoon.', category: 'driving', tags: ['popular'], thumbnail: '/images/games/driving/drift-tycoon.png', embedUrl: 'https://games.crazygames.com/en_US/drift-tycoon/index.html', rating: 0, plays: 0 },
  { id: 'ring-restaurant', title: 'Ring Restaurant', description: 'Build and run a futuristic restaurant in space.', category: 'simulation', tags: ['new'], thumbnail: '/images/games/simulation/ring-restaurant.png', embedUrl: 'https://games.crazygames.com/en_US/ring-restaurant/index.html', rating: 0, plays: 0 },
  { id: 'idle-game-dev-simulator', title: 'Idle Game Dev', description: 'Start a game studio and become the most successful developer in history.', category: 'simulation', tags: ['popular'], thumbnail: '/images/games/simulation/idle-game-dev-simulator.png', embedUrl: 'https://games.crazygames.com/en_US/idle-game-dev-simulator/index.html', rating: 0, plays: 0 },
  { id: 'evil-tower-lli', title: 'Evil Tower LLI', description: 'Climb the evil tower and defeat the monsters inside.', category: 'action', tags: ['arcade'], thumbnail: '/images/games/action/evil-tower-lli.png', embedUrl: 'https://games.crazygames.com/en_US/evil-tower-lli/index.html', rating: 0, plays: 0 },
  { id: 'laptop-empire', title: 'Laptop Empire', description: 'Start a tech company and dominate the laptop market.', category: 'simulation', tags: ['new'], thumbnail: '/images/games/simulation/laptop-empire.png', embedUrl: 'https://games.crazygames.com/en_US/laptop-empire/index.html', rating: 0, plays: 0 },
  { id: 'mine-clicker', title: 'Mine Clicker', description: 'Click to mine blocks, gather resources, and upgrade your gear.', category: 'clicker', tags: ['popular'], thumbnail: '/images/games/clicker/mine-clicker.png', embedUrl: 'https://games.crazygames.com/en_US/mine-clicker-gyi/index.html', rating: 0, plays: 0 },
