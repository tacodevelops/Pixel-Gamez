...
export default function Sidebar() {
  ...
  return (
    <nav className="sidebar">
      ...
      <Link href="/community" className={`sidebar__link ${pathname === '/community' ? 'active' : ''}`}>
        <span className="sidebar__icon"><Icon name="community" /></span>
        <span className="sidebar__label">{t('community')}</span>
      </Link>
